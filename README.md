...
> 🍵 **Java**, Plus de 2 ans d'expérience _(Langage que j'utilise principalement)_<br>
...
> 🏷️ **Description** : Un addon à EssentialsX qui lui ajoute des interfaces graphiques pour ses principales fonctionnalités, comme les "homes", les "kits", les "warps", etc.<br>
> 🌐 **Langage** : Java _(Spigot API)_<br>
> 📊 **État** : En cours de développement _(Version bêta disponible)_<br>
> 🗃️ **Dépôt GitHub** : [EssentialsX-GUI](https://github.com/SniperTVmc/EssentialsX-GUI)<br>
